...
Colocalization with 29 blood relevant traits (red blood cell count, platelet count, neutrophil count, etc.) and 3 autoimmune diseases (ulcerative colitis, Crohn's disease and inflammatory bowel disease). Testis contained the most colocalization (27 traits with at least one colocalization), followed by skin (18), blood (15), nerve (11) and thyroid (10). But blood had the highest colocalization proportion (# cololization / # of trans-eQTL loci).
