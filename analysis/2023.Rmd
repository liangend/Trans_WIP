...
### 4. New read count results based on GENCODE gtf (v26, adjusted for mappability)
After QC and removing genes on chrX, chrM and chrY, 12929 genes for 670 individuals were kept.

### 5. cis-eQTL analysis
Include 5 genotype PCs, 3 factors (sex, pcr, platform), 10 of expression PCs as covariates.

12360 eGenes (qval < 0.05) in GTEx data; 13275 eGenes in my analysis.

1871 same variants associated with the same eGene
