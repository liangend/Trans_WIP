...
Using univariate analysis for the 4113 aptamers, there are in total 324,928 significant (p < 5e-8/4728) SNP-protein pairs. 171,628 of them are trans signals (on different chromosomes with the target gene) in 1031 loci (200 kb window around the leading signal). 
