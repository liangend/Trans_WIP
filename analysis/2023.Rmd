...
### 5. cis-eQTL analysis
Included 5 genotype PCs, 3 factors (sex, pcr, platform), 10 of expression PCs as covariates. 
...
```{r echo=F, out.width="40%", fig.align='center', fig.cap="Comparison of the slopes of shared variants"}
