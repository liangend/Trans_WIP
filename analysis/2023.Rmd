...
In trans-eQTL mapping for DGN, there are 3899 significant trans-eQTL SNP–module pairs (Wang et al., 2022). 3421 of the SNPs were also included in the GTEx genotype. For the 12132 genes (166 gene modules) included in Wang et al. (2022), there are 10547 genes included in my analysis. For 1241 signals analyzed, 50 (4.0%) were replicated in my analysis (p < 0.05/3421).
...
Much more significant signals were found in GTEx data (648499 signals from ~200 chromosome-module pairs). I then investigated the regulatory activity of these signals and those from Wang et al. (2022) based on chromatin states of neutrophils from peripheral blood (Roadmap project).
```{r echo=F, fig.align='center', fig.cap="Comparing the p values of PCO and ACAT"}
