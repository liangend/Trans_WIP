...
```{r echo=F, fig.align='center', fig.cap="Number of significant SNPs across modules"}
...
```{r echo=F, fig.align='center', fig.cap="Number of significant SNPs across chromosomes"}
...
```{r echo=F, fig.align='center', fig.cap="Module division comparison"}
knitr::include_graphics(c("assets/mod_div_comp.png"), error = FALSE)
```

### 6. Summary of 7 tissues
```{r echo=F, fig.align='center', fig.cap="Summary of each tissue (10_mod_div_comp.R)"}
knitr::include_graphics(c("assets/basic_stats.png"), error = FALSE)
```

```{r echo=F, fig.align='center', fig.cap="Significant modules and SNPs (10_sum_7tissues.R)"}
