...
I used a protein complex database, CORUM, to define protein modules PCO analysis of UKB data. There are in total 2074 protein complexes in CORUM database, including 9015 proteins (2799 unique ones). 372 protein complexes overlap with > 1 protein in UKB data, including 899 proteins (341 unique ones). The number of proteins in these complexes varies from 2 to 10 (mean: 2.4; median: 2). 

There are 516,665 significant module-SNP pairs (p < 5e-8/372). By grouping them into 200 kb loci around leading SNPs, there are 7193 module-loci pairs. By comparing to minimum p in the loci for each protein in UKB univariate analysis, there are 1170 loci only significant in PCO, 2886 loci with smaller p values in PCO.
