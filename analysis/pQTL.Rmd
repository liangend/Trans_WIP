...
There are 966,157 significant module-SNP pairs (p < 5e-8/598). By grouping them into 200 kb loci around leading SNPs, there are 12155 module-loci pairs for 519 modules. By comparing to minimum p in the loci for each protein in UKB univariate analysis, there are 1676 loci only significant in PCO, 4957 loci with smaller p values in PCO.
...
Among 12155 trans-pQTLs, 1465 (248 modules) of them are located on the same chromosome of one of proteins in the targeting protein complex. Average distance of leading SNP to the nearest gene is 35,964,293, median distance is 20,441,333. 265 (66 modules) of them are within 1 Mb.
...
For the 265 loci with nearby gene (within 1 Mb) as a subunit of the targeting protein complex, 157 (31 modules) of them have the corresponding summary stats (23 proteins). 76/157 (23 modules, 17 proteins) of the leading SNP in trans-pQTL are a significant cis-pQTL of the nearby gene (p < 0.05/157), 67/157 are genome-wide significant (p < 5e-8/2837). 
...
I first found the most significant cis and trans SNP for each protein in UKB dataset, and then find the corresponding Z values in Sun et al. (2018). As in gene expression, the most extreme cis effects in protein are larger than trans.
